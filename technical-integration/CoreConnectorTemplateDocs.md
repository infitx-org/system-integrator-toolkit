...
By default the core connector exposes port 3003 for incoming payments and port 3004 for outgoing payments. For more information about the core connector networking, [learn more](/implementation-guides/Networking.md)
...
- `core-connector-svc`: This folder contains code that handles the way the api is exposed over a RESTFUL interface.[learn more](/advanced-topics/Service.md)
- `domain`: This folder contains the business logic of the core connector and all client classes used to communicate with the [DFSP](./CBSClient.md) and [Mojaloop Connector](./SDKClient.md).  
...
- Implement a client for the core banking api. [learn more](./CBSClient.md)
- Refactor the aggregate function for `getParties` prepare a response for the mojaloop connector based on the data received from the DFSP core banking api. [learn more](./CoreConnectorAggregate.md#get-parties)
- Write unit and integration tests to verify the functionality. [learn more](/implementation-guides/Testing.md)
...
- Check the request body has the correct currency as supported by the core connector. The supported currency is configured in the core connector environment variables. [Learn more](/implementation-guides/Configuration.md) about configuration management.
...
- Implement a client for the core banking api. [learn more](./CBSClient.md)
- Refactor the aggregate function for `quoteRequests` to perform the tasks as listed above and prepare a response for the mojaloop connector as specified in the mojaloop connector backend api. [learn more](./CoreConnectorAggregate.md#quote-requests)
- Write unit and integration tests to verify the functionality. [learn more](/implementation-guides/Testing.md)
...
- Implement a client for the core banking api. [learn more](./CBSClient.md)
- Refactor the aggregate function for `transfers` to perform the tasks as listed above and prepare a response for the mojaloop connector as specified in the mojaloop connector backend api [learn more](./CoreConnectorAggregate.md#transfers)
- Write unit and integration tests to verify the functionality [lean more](/implementation-guides/Testing.md)
...
- Implement the client for the core banking api and make sure it supports transfering funds to the customer's account. [learn more](./CBSClient.md)
- Refactor the aggregate function for the `putNotification` to perform the task of checking transfer state and crediting funds into the customer's account. [learn more](./CoreConnectorAggregate.md#put-transfer-notification)
...
- Read through the aggregate function that executes this function. [learn more](./CoreConnectorAggregate.md#send-money)
